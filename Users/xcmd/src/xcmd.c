...
xcmd_t *_xcmd_cmd_list_start = NULL;
xcmd_t *_xcmd_cmd_list_end = NULL;
xcmd_key_t *_xcmd_key_list_start = NULL;
xcmd_key_t *_xcmd_key_list_end = NULL;

void xcmd_cmd_function_init(const void *begin, const void *end) {
    _xcmd_cmd_list_start = (xcmd_t *) begin;
    _xcmd_cmd_list_end = (xcmd_t *) end;
}

void xcmd_key_function_init(const void *begin, const void *end) {
    _xcmd_key_list_start = (xcmd_key_t *) begin;
    _xcmd_key_list_end = (xcmd_key_t *) end;
}
#endif
#endif
...
#ifdef ENABLE_XCMD_EXPORT
#ifdef __ARMCC_VERSION  /* ARM C Compiler */
    extern const int _xcmd_cmd_list$$Base;
    extern const int _xcmd_cmd_list$$Limit;
    extern const int _xcmd_key_list$$Base;
    extern const int _xcmd_key_list$$Limit;
    xcmd_cmd_function_init(&_xcmd_cmd_list$$Base, &_xcmd_cmd_list$$Limit);
    xcmd_key_function_init(&_xcmd_key_list$$Base, &_xcmd_key_list$$Limit);
#endif
#endif
